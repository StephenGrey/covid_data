...
class MapTest(GraphTest):
    ...
    def test_coverage(self):
        ...
        coverage=([x.get('properties')['lad16cd'] for x in mapdata.get('objects').get('Local_Authority_Districts_December_2016_Generalised_Clipped_Boundaries_in_Great_Britain').get('geometries')])
